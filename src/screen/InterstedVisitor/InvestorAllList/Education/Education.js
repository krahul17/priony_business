...
const Education = () => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-api-for-Intersted-Visitor-in-education-lone', {
            headers: {
    ...
    const Getdata = ({ item }) => {
        ...
        useEffect(async () => {
            ...
            fetch(BaseUrl + '/douryou-seller-api/seller-check-user-education-lone-user-favourite-or-not/' + item.id + "/", {
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer ' + accessToken ,
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'Education Lone User'
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            <View style={styles.topad}>
                                <Image source={require('../../../HomeScreen/assets/Loan.png')} style={styles.ad} />
                            </View>

                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Education Loan</Text>
                            </View>
