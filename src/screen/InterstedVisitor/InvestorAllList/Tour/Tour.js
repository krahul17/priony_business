...
const Tour = () => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-api-for-Intersted-Visitor-in-tour-and-treavel-package', {
            headers: {
    ...
    const Getdata = ({ item }) => {
        ...
        useEffect(async () => {
            ...
            fetch(BaseUrl + '/douryou-seller-api/seller-check-user-tour-and-travel-package-user-favourite-or-not/' + item.id + "/", {
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer ' + accessToken ,
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'Tour & Travel Package User'
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            <View style={styles.topad}>
                                <Image source={require('../../../HomeScreen/assets/TourTravel.png')} style={styles.ad} />
                            </View>

                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Tour and Travel</Text>
                            </View>
