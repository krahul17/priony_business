...
const Accomodation = () => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-api-for-Intersted-Visitor-in-accmudation-at-abroad', {
            headers: {
    ...
    const Getdata = ({ item }) => {
        ...
        useEffect(async () => {
            ...
            fetch(BaseUrl + '/douryou-seller-api/seller-check-user-accommodation-user-favourite-or-not/' + item.id + "/", {
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer ' + accessToken ,
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'Accommodation User'
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            <View style={styles.topad}>
                                <Image source={require('../../../HomeScreen/assets/Accom.png')} style={styles.ad} />
                            </View>

                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Accomodation Abroad</Text>
                            </View>
