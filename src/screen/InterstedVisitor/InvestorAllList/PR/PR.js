...
const PR = () => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-api-for-Intersted-Visitor-in-permanent-resedence', {
            headers: {
    ...
    const Getdata = ({ item }) => {
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'Permanent Residen User'
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            ...
                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>PR</Text>
                            </View>
