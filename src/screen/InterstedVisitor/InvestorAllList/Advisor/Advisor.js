...
const Advisor = () => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-api-for-Intersted-Visitor-in-legial-advisor', {
            headers: {
    ...
    const Getdata = ({ item }) => {
        ...
        useEffect(async () => {
            ...
            fetch(BaseUrl + '/douryou-seller-api/seller-check-user-legal-advisor-user-favourite-or-not/' + item.id + "/", {
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer ' + accessToken ,
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            <View style={styles.topad}>
                                <Image source={require('../../../HomeScreen/assets/LegalAdv.png')} style={styles.ad} />
                            </View>

                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Legal Advisor</Text>
                            </View>
