import { StyleSheet, Text, View, FlatList, Linking,StatusBar, ScrollView, Image, TouchableOpacity, Dimensions } from 'react-native'
...
const Courier = () => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-api-for-Intersted-Visitor-in-international-curear', {
            headers: {
    ...
    const Getdata = ({ item }) => {
        ...
        useEffect(async () => {
            ...
            fetch(BaseUrl + '/douryou-seller-api/seller-check-user-international-courier-user-favourite-or-not/' + item.id + "/", {
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer ' + accessToken ,
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'International Courier User'
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            <View style={styles.topad}>
                                <Image source={require('../../../HomeScreen/assets/Internation.png')} style={styles.ad} />
                            </View>

                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>International Courier</Text>
                            </View>
