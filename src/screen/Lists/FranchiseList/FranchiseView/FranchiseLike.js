...
const FranchiseLike = ({ route }) => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-see-who-like-sell-franchise/' + todayid + '/', {
            headers: {
    ...
    const GustData = ({ item }) => {
        ...
        useEffect(async () => {
            try {
                ...
                fetch(BaseUrl + '/douryou-seller-api/seller-check-user-like-franchise-user-favourite-or-not/' + item.id + "/", {
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json",
                        'Authorization': 'Bearer ' + accessToken,
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            ...
                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Franchise Likes</Text>
                            </View>
