...
const ViewAds = ({ route }) => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-see-who-view-Todays-Deals/' + todayid + '/', {
            headers: {
    ...
    const GustData = ({ item }) => {
        ...
        useEffect(async () => {
            try {
                ...
                fetch(BaseUrl + '/douryou-seller-api/seller-check-user-view-todays-deals-favourite-or-not/' + item.id + "/", {
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json",
                        'Authorization': 'Bearer ' + accessToken,
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'View Todays Deal'
