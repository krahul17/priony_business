      ...
      <View style={styles.Name1}>
                <View style={styles.topmain}>
                    <View style={styles.topad}>
                        <Image source={require('../../../Navigation-Flow/TopTabNavigation/assets/four.png')} style={styles.ad} />
                    </View>

                    <View style={styles.maintext}>
                        <Text style={styles.toptext}>Yours Interviews</Text>
                    </View>
        ...
        <View style={styles.listboarder}>
          <View style={{ flexDirection: 'row', }}>
            ...
            <View>
              <Text style={styles.text}>Post Time :- {item.AddedTime.slice(0,8)}</Text>
            </View>
          </View>
        </View>
