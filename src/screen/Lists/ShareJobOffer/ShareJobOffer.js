...
const ShareJobOffer = ({route}) => {

    const {item}= route.params
    const todayid= item.JobOfferID
  ...
  useEffect( async () => {
    ...
    fetch(BaseUrl + '/douryou-seller-api/seller-see-who-view-job-offer/' + todayid +'/' , {
        headers: {
    ...
    const GustData = ({ item }) => {
        ...
        useEffect(async () => {
            try {
                ...
                fetch(BaseUrl + '/douryou-seller-api/seller-check-user-shear-job-offer-favourite-or-not/' + item.id + "/", {
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json",
                        'Authorization': 'Bearer ' + accessToken,
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'Share Job Offer'
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            ...
                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Share JobOffer</Text>
                            </View>
