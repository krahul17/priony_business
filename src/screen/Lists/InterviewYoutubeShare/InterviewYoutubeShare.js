...
const InterviewYoutubeShare = ({ route }) => {
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-see-who-view-interview/' + todayid + '/', {
            headers: {
    ...
    const GustData = ({ item }) => {
        ...
        useEffect(async () => {
            try {
                ...
                fetch(BaseUrl + '/douryou-seller-api/seller-check-user-shear-interview-favourite-or-not/' + item.id + "/", {
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json",
                        'Authorization': 'Bearer ' + accessToken,
        ...
        const favorate = async () => {
            ...
            let gettingfav = 'Share Interview'
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            ...
                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Share Interviews</Text>
                            </View>
...
export default InterviewYoutubeShare
