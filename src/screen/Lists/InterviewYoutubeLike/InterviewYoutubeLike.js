...
const InterviewYoutubeLike = ({ route }) => {

    const { item } = route.params
    const todayid = item.id

    console.log(todayid, 'gett id ');
    ...
    console.log(data.first_name, " hello im liked")
    ...
    useEffect(async () => {
        ...
        fetch(BaseUrl + '/douryou-seller-api/seller-see-who-like-interview/' + todayid + '/', {
            headers: {
    ...
    const GustData = ({ item }) => {
        ...
        useEffect(async () => {
            try {
                ...
                fetch(BaseUrl + '/douryou-seller-api/seller-check-user-like-interview-favourite-or-not/' + item.id + "/", {
                    headers: {
                        "Accept": "application/json",
                        "Content-Type": "application/json",
                        'Authorization': 'Bearer ' + accessToken,
            ...
            <ScrollView style={{ backgroundColor: '#fff', flex: 1 }}>
                <View>
                    ...
                    <View style={styles.Name1}>
                        <View style={styles.topmain}>
                            ...
                            <View style={styles.maintext}>
                                <Text style={styles.toptext}>Like Interviews</Text>
                            </View>
                    ...
                    <FlatList
                        ...
                        data={data}
                        // renderItem={GustData}
                        keyExtractor={SellerProfile => SellerProfile.id}
...
export default InterviewYoutubeLike
